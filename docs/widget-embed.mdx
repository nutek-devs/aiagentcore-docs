...
The VigilSquad widget is a lightweight chat interface that you embed on your website. It connects to your AI agent via WebSocket and supports real-time streaming responses.
...
| `removeBranding` | `boolean` | `false` | Hide "Powered by VigilSquad" |
...
- **Session persistence:** Client ID stored in `localStorage` (`vigilsquad_cid_{integrationId}`)
