...
VigilSquad uses **Bearer token authentication**. All protected API endpoints require a valid token in the `Authorization` header.
...
1. Log in to [app.vigilsquad.com](https://app.vigilsquad.com)
2. Go to **Settings**
