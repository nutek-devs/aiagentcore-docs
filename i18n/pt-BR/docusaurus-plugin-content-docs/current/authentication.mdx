...
O VigilSquad utiliza **autenticacao via Bearer token**. Todos os endpoints protegidos da API exigem um token valido no header `Authorization`.
...
1. Faca login em [app.vigilsquad.com](https://app.vigilsquad.com)
